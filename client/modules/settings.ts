...
export const defaultSettings = {
  ...
  systemPrompt: `Answer using the search results below as your primary source, supplemented by your own knowledge when needed. Write your response in English.
...
{{searchResults}}`,
  ...
  guardiumaiEndpointId: "EHF-OPENAI-API-LLM",
